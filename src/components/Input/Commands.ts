...
const content = {
  ...
  bio: `Hi! :D i‘m Nick Hu. I am a web developer based in the picturesque Perth, Western Australia.\n
    ...
    React + Next.js + Sanity CMS + GraphQL is my main JAM. ;)\n
    Javascript/Typescript is where I feel at home, but i'm not afraid to use PHP, Ruby, Python when need be.`,
  contact: `feel free to email me via <a href="mailto:nick@nickhu.info">nick@nickhu.info</a>,
    check out my <a href="https://github.com/nicholashu" target="_blank">GitHub</a>, or connect with me on <a href="https://www.linkedin.com/in/nick-hu-perth/" target="_blank">linkedIn</a>`,
  examples: `I currently work for <a href="https://airteam.com.au" target="_blank">Airteam</a> remotely from Perth, Western Australia as a Full Stack Web Developer.\n
    ...
    <a href="https://mhnsw.au" target="_blank">Museums of History NSW</a>\n
    <a href="https://www.hbfdental.com.au/" target="_blank">HBF Dental</a>\n
